...
Namespace XpfMapFromMajorRoutes
    Partial Public Class MainPage
        ...
        Private Function GetCalculateRoutesArguments() As Boolean
            ...
            If cbTravelMode.SelectedIndex = 0 Then
                options.Mode = BingTravelMode.Driving
            Else
                options.Mode = BingTravelMode.Walking
            End If

            If cbRouteOptimization.SelectedIndex = 0 Then
...
'                #End Region ' #CalculateMajorRoutes
        ...
        Private Sub bCalculateRoute_Click(ByVal sender As Object, ByVal e As RoutedEventArgs)
        ...
        Private Sub BingRouteDataProvider_RouteCalculated(ByVal sender As Object, ByVal e As DevExpress.Xpf.Map.BingRouteCalculatedEventArgs)
